...
<div class="upcoming-cards">
  ...
  <div class="upcoming-card">
    ...
    <p style="margin-bottom: 16px;">An example client-side implementation indexing, listing, and running discovery for multiple registered agents and augments.</p>
  ...
  <div class="upcoming-card">
    ...
    <p style="margin-bottom: 16px;">An example dynamic discovery service built according to the ADP specification. Demonstrates direct <code>POST /search</code> capabilities.</p>
...
<div class="upcoming-cards">
  ...
  <div class="upcoming-card">
    ...
    <p>Auto-discovery and tenant-isolated dynamic routing discovery services matching Entra ID authorization profiles.</p>
  </div>
</div>
...
Exposing your agents and augments to ADP discovery services is simple.
